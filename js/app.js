function iniciarApp() {
    ...
    function mostrarRecetas(recetas = []) {
        ...
        const headind = document.createElement("H2");
        headind.classList.add("text-center", "text-black", "my-5");
        headind.textContent = recetas.length ? "Resultados" : "No hay resultados";
        resultado.appendChild(headind);
